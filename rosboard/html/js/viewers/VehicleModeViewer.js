"use strict";
 class VehicleMode extends Viewer {
	/**
...
VehicleMode.friendlyName = "RCS Race State Viewer";
VehicleMode.supportedTypes = [
	"tritonairacer_interfaces/msg/VehicleMode",
];

Viewer.registerViewer(VehicleMode);
